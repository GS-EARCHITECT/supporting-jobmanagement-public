package job_template_details_read_mgmt.model.details;
...
public class JobTemplateDetails implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private JobTemplateDetailsPK id;
	...
	public JobTemplateDetailsPK getId() {
		return id;
	}

	public void setId(JobTemplateDetailsPK id) {
		this.id = id;
	}
	...
	public JobTemplateDetails(JobTemplateDetailsPK id, Integer weeksPlus, Integer monthsPlus, Integer daysPlus,
