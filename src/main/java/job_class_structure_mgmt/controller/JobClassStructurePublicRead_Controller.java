...
import job_class_structure_mgmt.services.I_JobClassStructurePublicRead_Service;

@RestController
@RequestMapping("/jobClassStructurePublicReadMgmt")
public class JobClassStructurePublicRead_Controller 
{
	@Autowired
	private I_JobClassStructurePublicRead_Service jobClassStructurePublicReadService;
	...
	public ResponseEntity<CopyOnWriteArrayList<JobClassStructure_DTO>> getSelectJobClassStructures(
		...
		try {
			jobClassStructure_DTOs = jobClassStructurePublicReadService.getSelectJobClassStructures(ids, pids);
	...
	public ResponseEntity<CopyOnWriteArrayList<JobClassStructure_DTO>> getSelectJobClassesByParents(
		...
		try {
			jobClassStructure_DTOs = jobClassStructurePublicReadService.getSelectJobClassesByParents(ids);
			jobClassStructureList = jobClassStructure_DTOs.get();
	...
	public ResponseEntity<CopyOnWriteArrayList<JobClassStructure_DTO>> getSelectJobClassesByParties(
		...
		try {
			jobClassStructure_DTOs = jobClassStructurePublicReadService.getSelectJobClassesByParties(ids);
			jobClassStructureList = jobClassStructure_DTOs.get();
	...
	public ResponseEntity<CopyOnWriteArrayList<JobClassStructure_DTO>> getAllJobClassStructures() {
		...
		try {
			jobClassStructure_DTOs = jobClassStructurePublicReadService.getAllJobClassStructures();
			jobClassStructureList = jobClassStructure_DTOs.get();
