...
@Repository("jobClassStructurePublicReadRepo")
public interface JobClassStructurePublicRead_Repo extends JpaRepository<JobClassStructure, JobClassStructurePK> 
{

	@Query(value = "select * from JOB_CLASS_STRUCTURE ORDER BY JOB_CLASS_SEQ_NO", nativeQuery = true)
	CopyOnWriteArrayList<JobClassStructure> getAllJobClassStructures();
