...
public class JobTemplateMasterDTO implements Serializable {
	...
	public JobTemplateMasterDTO(long jobTemplateSeqNo, long serviceSeqNo, BigDecimal serviceCategorySeqNo,
