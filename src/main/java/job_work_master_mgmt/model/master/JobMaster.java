package job_work_master_mgmt.model.master;
...
public class JobMaster implements Serializable {
	...
	public JobMaster(long serviceWorkSeqNo, Long companySeqNo, Timestamp createdOn, Long jobTemplateSeqNo,
			BigDecimal opFlag, Long managerSeqNo, Long serviceSeqNo, String jobRefId, Character schType,
			Character schFlag) {
		super();
		this.serviceWorkSeqNo = serviceWorkSeqNo;
		this.companySeqNo = companySeqNo;
